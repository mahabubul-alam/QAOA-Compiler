...
* -output_qasm_file_name string: File name to write the compiled parametric QAOA circuit. The output is written in qasm format. The default value is 'QAOA.qasm'. The files are written following this naming convention: {Method(IP/IC/VIC/IterC)}_{output_qasm_file_name}.
